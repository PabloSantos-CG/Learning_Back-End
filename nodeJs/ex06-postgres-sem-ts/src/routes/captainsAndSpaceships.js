...
router.post("/spaceships", spaceshipsController.create_Spaceship);
...
router.post("/spaceships/:spaceId/addCaptain", spaceshipsController.addCaptain);
router.post("/spaceships/:spaceId/removeCaptain", spaceshipsController.removeCaptain);
